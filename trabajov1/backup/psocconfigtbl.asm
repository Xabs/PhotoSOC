...
;  Ordered Global Register values
	M8C_SetBank1
	mov	reg[00h], 57h		; Port_0_DriveMode_0 register (PRT0DM0)
	...
	M8C_SetBank1
	mov	reg[08h], 55h		; Port_2_DriveMode_0 register (PRT2DM0)
	mov	reg[09h], aah		; Port_2_DriveMode_1 register (PRT2DM1)
	M8C_SetBank0
	mov	reg[0bh], aah		; Port_2_DriveMode_2 register (PRT2DM2)
...
;       Instance name Segundos, Block Name TIMER16_LSB(DBB10)
	mov	reg[33h], 00h		;Segundos_CONTROL_LSB_REG(DBB10CR0)
	mov	reg[31h], 00h		;Segundos_PERIOD_LSB_REG(DBB10DR1)
	mov	reg[32h], 00h		;Segundos_COMPARE_LSB_REG(DBB10DR2)
;       Instance name Segundos, Block Name TIMER16_MSB(DBB11)
	mov	reg[37h], 04h		;Segundos_CONTROL_MSB_REG(DBB11CR0)
	mov	reg[35h], 00h		;Segundos_PERIOD_MSB_REG(DBB11DR1)
	mov	reg[36h], 00h		;Segundos_COMPARE_MSB_REG(DBB11DR2)
