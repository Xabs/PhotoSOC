...
#define CLOCK_DIV_VC3          0x95    // VC3 clock divider
#define CLOCK_DIV_VC3_MASK     0xff    // VC3 clock divider mask
#define CLOCK_DIV_VC3_JUST     0x95    // VC3 clock divider justified
...
#define PORT_0_DRIVE_0         0x55    //Port 0 drive mode 0 register (PRT0DM0)
#define PORT_0_DRIVE_1         0xaa    //Port 0 drive mode 1 register (PRT0DM1)
#define PORT_0_DRIVE_2         0x0     //Port 0 drive mode 1 register (PRT0DM2)
#define PORT_0_INTENABLE       0xab    //Port 0 interrupt enable register (PRT0IE)
#define PORT_0_INTCTRL_0       0x2     //Port 0 interrupt control 0 register (PRT0IC0)
#define PORT_0_INTCTRL_1       0xab    //Port 0 interrupt control 1 register (PRT0IC1)
#define PORT_1_GLOBAL_SELECT   0x50    //Port 1 global select register (PRT1GS)
...
#define PORT_2_DRIVE_0         0x55    //Port 2 drive mode 0 register (PRT2DM0)
#define PORT_2_DRIVE_1         0xaa    //Port 2 drive mode 1 register (PRT2DM1)
#define PORT_2_DRIVE_2         0xaa    //Port 2 drive mode 2 register (PRT2DM2)
